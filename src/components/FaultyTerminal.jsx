...
export default function FaultyTerminal({
  ...
  const propsRef = useRef({ pause, timeScale, pageLoadAnimation, mouseReact });
  useEffect(() => {
    propsRef.current = { pause, timeScale, pageLoadAnimation, mouseReact };
  }, [pause, timeScale, pageLoadAnimation, mouseReact]);
  ...
  useEffect(() => {
    ...
    const update = (t) => {
      ...
      if (currentProps.pageLoadAnimation && loadAnimationStartRef.current === 0) {
        loadAnimationStartRef.current = t;
      }
      if (!currentProps.pause) {
        const elapsed = (t * 1e-3 + timeOffsetRef.current) * currentProps.timeScale;
