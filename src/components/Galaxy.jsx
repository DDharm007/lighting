...
export default function Galaxy({
  ...
  const propsRef = useRef({ disableAnimation, starSpeed, mouseInteraction });
  useEffect(() => {
    propsRef.current = { disableAnimation, starSpeed, mouseInteraction };
  }, [disableAnimation, starSpeed, mouseInteraction]);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    function update(t) {
      ...
      if (!currentProps.disableAnimation) {
        ...
        program.uniforms.uStarSpeed.value = t * 1e-3 * currentProps.starSpeed / 10;
      }
